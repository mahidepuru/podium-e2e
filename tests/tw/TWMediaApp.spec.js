...
describe('travelweekly Media AppAdminPage', function () {
    ...
    var SaveAlbumButton = element(by.buttonText('button'));
...
// These are the re usable elements //
    ...
    function beforeEachSetup() {
        browser.get('http://staging.travelweekly.co.uk/app/admin/login');
...
//The above test case works ad add video//
    ...
    describe('Delete Images and Videos', function () {
        it ('should update imageinfo and delete image aswell',function(){
            ...
            var CheckBox = element(by.css('[ng-click= "vm.togglePhotoSelection(media.id)"]')).click();
